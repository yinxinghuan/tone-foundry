...
- **Buttons**：主要动作使用 1950–70 年代工坊设备感的钴蓝烤漆金属按键，带窄暗边、顶部反光和 3–4 px 实体按压行程，至少 48 px 高；试听 / 缩放工具继续使用黑色金属放大器面板，次级纸面动作使用靛蓝描边与下划线。
...
- **Progress**：仅显示 5 个 `4–6 px` 蓝墨圆点，放在一张极小的工单票根上；当前点略宽，禁止数字步骤名、平台规格和整行 tab。
