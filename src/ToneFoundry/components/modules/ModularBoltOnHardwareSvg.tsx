  ...
  return (
    <g className="tf-module-hardware" data-guitar-module={`bolt-on-hardware-${pickups}-${bridge}`}>
      <g data-guitar-part={`pickguard-${body}`}>
        ...
        {body === 'thinline' && <path d="M272 666 L272 734 C247 736 230 746 220 765 C233 791 234 819 224 848 C217 871 219 892 234 906 L253 906 L253 893 L348 893 L348 906 L378 906 C383 871 396 830 411 792 C426 753 435 698 418 672 C401 658 379 674 366 697 C357 715 345 729 326 728 L326 666 Z" fill={`url(#${prefix}-guard)`} stroke="#50453a" strokeWidth="1" vectorEffect="non-scaling-stroke" />}
        {body === 'reverse' && <path d="M274 686 C246 671 224 649 210 632 C204 654 209 683 225 705 C239 724 242 746 233 772 C222 806 226 841 249 864 L255 904 C286 923 344 919 373 897 L378 839 C402 811 415 778 416 745 C418 714 407 689 386 680 C364 670 342 684 328 704 C315 721 304 725 292 714 C283 706 279 694 274 686 Z" fill={`url(#${prefix}-guard)`} stroke="#6a655d" strokeWidth="1" vectorEffect="non-scaling-stroke" />}
      </g>
      ...
      <g data-guitar-part="controls">
        {body === 'slab' || body === 'thinline' ? <g><rect x="377" y="833" width="34" height="168" rx="17" fill={`url(#${prefix}-nickel)`} stroke="#474a46" strokeWidth="1" />{[920,970].map((y) => <circle key={y} cx="394" cy={y} r="13" fill={`url(#${prefix}-knob)`} stroke="#4e514d" strokeWidth=".8" />)}<path d="M388 862 L401 844" stroke="#979994" strokeWidth="3" strokeLinecap="round" /></g> : <g>{[body === 'offset' || body === 'reverse' ? 397 : 384, body === 'offset' || body === 'reverse' ? 414 : 412].map((x, index) => <circle key={x} cx={x} cy={index ? 933 : 892} r="13" fill={`url(#${prefix}-knob)`} stroke="#4e514d" strokeWidth=".8" />)}<path d="M380 848 L393 832" stroke="#979994" strokeWidth="3" strokeLinecap="round" /></g>}
      </g>
    </g>
  )
}
