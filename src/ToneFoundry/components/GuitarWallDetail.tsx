...
interface Props { entry:WallEntry; guitar:GuitarSpec; parts:Array<{label:string;value:string}>; playing:boolean; onPlay:()=>void; onBack:()=>void; onRemix?:()=>void }
...
export function GuitarWallDetail({entry,guitar,parts,playing,onPlay,onBack,onRemix}:Props) {
